...
<?php } else { 
	...
	<?php if (isset($cim_customer_profile->paymentProfiles)) {?>
		<div style="width: inherit;"><input type="radio" name="select_payment_account" onchange="$('#cim_payment_option2').slideUp();$('#cim_payment_option3').slideUp();$('#payment_billing_address').slideUp();"
	...
	<?php } ?>	
		<div><input type="radio" name="select_payment_account" onchange="$('#cim_payment_option3').slideUp();$('#cim_payment_option2').slideDown();$('#payment_billing_address').slideDown();"
