...
height: 100%;
z-index: 9999;
background: url('https://loading.io/spinners/dual-ring/lg.dual-ring-loader.gif') 50% 50% no-repeat rgb(249,249,249);
opacity: .8;
...
function showLoginForm(){
	...
	bootbox.dialog({
	  ...
	  '<div class="load"></div>'+
				...
				'<a href="javascript:void(0);" onclick="fbLogin()" id="fbLink" class="fb btn1" style="width: 49%; float: left;">'+
				'<i class="fa fa-facebook fa-fw" style="color:white"></i>Login with Facebook</a> '+
				'<a href="javascript:void(0);" onclick="callSignIn()" id="gLink" class="google btn1" style="width: 49%; float: right;">'+
