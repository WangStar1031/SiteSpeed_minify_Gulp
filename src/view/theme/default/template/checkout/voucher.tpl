  ...
  <div id="collapse-voucher" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <input type="submit" value="<?php echo $button_voucher; ?>" id="button-voucher" data-loading-text="<?php echo $text_loading; ?>"  class="btn btn-primary shop_btn" />
        </span> </div>
      <script type="text/javascript"><!--
$('#button-voucher').on('click', function() {
  $.ajax({
    url: '<?php echo BASE; ?>index.php?route=checkout/voucher/voucher',
    type: 'post',
