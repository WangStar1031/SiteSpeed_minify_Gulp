											...
											<div class="CommonInputForm loginInputForm">
														<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
															...
															<fieldset id="account">
															  ...
															  <h6><?php echo $text_account_already; ?></h6>
															...
															<fieldset id="address">
																  ...
																  <div class="form-group required">
																	<label class="col-sm-3 control-label" for="input-zone"><?php //echo $entry_zone; ?>STATE</label>
																	<div class="col-sm-9">
															  ...
															  <div class="form-group">
																...
																<?php echo $text_agree; ?>
																	<?php if ($agree) { ?>
																			 ...
																			 <input type="checkbox" name="agree" value="1" checked="checked"  style="opacity: 1;"/>
																	
																	<?php } else { ?>
																	
																			<input type="checkbox" name="agree" value="1" style="opacity: 1;"/>
