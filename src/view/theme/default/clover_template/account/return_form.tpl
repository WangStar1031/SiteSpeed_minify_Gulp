      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <div class="input-group date"><input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" placeholder="<?php echo $entry_date_ordered; ?>" data-date-format="MM-DD-YYYY" id="input-date-ordered" class="form-control" /><span class="input-group-btn">
        ...
        <div class="buttons clearfix">
          ...
          <div class="pull-right"><?php echo $text_agree; ?>
            ...
            <?php } ?>
            <input type="submit" value="<?php echo $button_submit; ?>" class="btn btn-primary shop_btn" />
          </div>
        </div>
        <?php } else { ?>
        <div class="buttons clearfix">
          <div class="pull-left"><a href="<?php echo $back; ?>" class="btn btn-default shop_btn"><?php echo $button_back; ?></a></div>
