...
$html_content .=	'<div style="height:1px;background-color:#000; margin:3px 0 6px 0;"></div>';	
...
$html_content .=	'<div style="height:3px;background-color:#000; margin:3px 0 6px 0;"></div>';
...
$html_content .=	'<table style="border-collapse: collapse; width: 95%;  margin-bottom: 20px;">
		<tbody>
		  <tr>
...
$html_content .=				'<div style="font-size: 12px; clear:both;">'.'- '.$option['name'].': </div>';
...
$html_content .=		'&nbsp;<small><span style="padding-left:8px; font-size:10px; clear:both;">'.$option['value'].'</span></small>';
										}else{
...
$html_content .= '<tfoot style=" background-image:url(\'//ec2-34-210-139-20.us-west-2.compute.amazonaws.com/ordering/common/upload/catalog/view/theme/default/image/paid_stamp.png\'); page-break-before: auto;">';
...
$html_content .=  '<tr>
			<td colspan="3"><div style="height:2px;background-color:#000; margin:3px 0 6px 0;position:relative">
			'.'<center style="position: absolute;top: -83px;left: 90px;"><img src="'.'http://ec2-34-210-139-20.us-west-2.compute.amazonaws.com//ordering/common/upload/catalog/view/theme/default/image/paid_stamp.png" title = "'.$store_name.'" alt="'.$store_name.'" style="margin-bottom: 20px; border: none; max-height:80px; width:auto;" height="50px" width="50px;"/></center>
			</div></td>
		  </tr>';			
	}else{
		$html_content .=  '<tr>
			<td colspan="3"><div style="height:2px;background-color:#000; margin:3px 0 6px 0;position:relative"> </div></td>
		  </tr>';
	}
}
			}
