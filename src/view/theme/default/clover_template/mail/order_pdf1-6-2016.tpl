...
<div style="width: 2.9in;">
	...
	<div style="text-align:center; font-size:12px;">
		...
		<?php			}else{				echo 'Customer';				}			?>		</p>	</div>
	<?php if($account_number_masked) {?>	<div style="margin:8px 5px; text-align:center">
		Credit Card: <?php echo $account_number_masked; ?> </br>
	</div>
	<?php } ?>
		...
		<tbody>
		  ...
		  <tr>
			<td colspan="3" style="padding: 2px 0 0 5px;">
				...
				<div style="height:1px;background-color:#000; margin:3px 0 6px 0; z-index:2;">
						<?php
						if($account_number_masked){ 
						?>
						
						<center><img src="<?php echo $base; ?>upload/catalog/view/theme/default/image/paid_stamp.png" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none; max-height:80px; width:auto;" height="50px" width="50px"/></center> </br>
						<?php
						}
						?>
