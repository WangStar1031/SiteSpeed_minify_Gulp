...
<link rel="shortcut icon" href="upload/image/BiteHeistF.ico" />
...
<script src="upload/catalog/view/javascript/PawelDecowski-jquery-creditcardvalidator-ec16ea1/jquery.creditCardValidator.js" type="text/javascript"></script>
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
<script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
<link href="upload/catalog/view/javascript/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen" />
<script src="upload/catalog/view/javascript/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="upload/catalog/view/javascript/bootbox/bootbox.js" type="text/javascript"></script>
<link href="upload/catalog/view/javascript/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
<link href="upload/catalog/view/theme/default/font/stylesheet.css" rel="stylesheet" type="text/css" />
<link href="upload/catalog/view/theme/default/stylesheet/bootstrap.css" rel="stylesheet">
<link href="upload/catalog/view/theme/default/stylesheet/style.css" rel="stylesheet">
<link href="upload/catalog/view/theme/default/stylesheet/responsive.css" rel="stylesheet">
<link href="upload/catalog/view/theme/default/stylesheet/stylesheet-pure-css.css" rel="stylesheet">
...
function updateCartInPanel( device ){
	...
	$.ajax({
		url: 'index.php?route=checkout/cart/editInPanel',
        type: 'post',
        data:  new_qty,
        dataType: 'html',
        beforeSend: function() {
...
function validateLogin() {
	...
	if(srch > 0)
		logout_page = 1;
	$.ajax({
			url: 'index.php?route=account/login/validateAjaxLogin',
			type: 'post',
...
function validateAjaxRegistration(){
	$.ajax({
			url: 'index.php?route=account/login/validateAjaxRegistration',
			type: 'post',
...
function customRegister() {
    ...
    $.ajax({
        url: 'index.php?route=checkout/register/customSave',
        type: 'post',
				  ...
				  buttons: {
					...
					danger: {
					  ...
					  callback: function() {
						  ...
						  $.ajax({
							url: 'index.php?route=common/home/unsetCurrentOrder',
							type: 'post',
							data: {unset : 'unset'},
							//dataType: 'json',
							beforeSend: function() {
			...
			<div>
					...
					<div class="left_header full-width-568">
							<a href="<?php echo $rootBase; ?>" class="logo" target="_blank" id="header_logo">
								<img src="<?php echo $base; ?>upload/image/catalog/BiteHeist_Logo.png" title="<?php echo $rootName; ?>" alt="<?php echo $rootName; ?>" class="img-responsive" />
							</a>
