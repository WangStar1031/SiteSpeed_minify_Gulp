...
<section class="ordering_options" id="locationAndStuff">
	<h2 class="top_head search_product" id="home_ribbon_text">ORDERING OPTIONS
	</h2>
				...
				<ul>  
					...
					<div class="list_contant" id="time_content" style="display:none;">
						...
						<a href="javascript:void(0)" id="order_for_now">
							<li class="white"><p><span style="float:left;" id="order_for_now_title">ORDER FOR NOW -</span> <aside style="float:left;" id="order_for_now_description">Have your order prepared as soon as possible.</aside></p></li>
						</a>
						
						<a href="javascript:void(0)" id="order_for_later">
							<?php if($order_later_status == 1 && $order_later_enabled_same_day_future_order == 1){?>	
							<li class="gray"><p><span style="float:left;">ORDER FOR LATER -</span> <aside style="float:left;" id="order_for_later_description">Have your order prepared at a specific future date & time.</aside></p></li>
							<?php } ?>
					...
					<?php if($delivery_option == '' || $delivery_option == 3) { //for both pikcup an delivery ?>
						...
						<div class="list_contant" id="method_content" style="display:none;">
							<a href="javascript:void(0);" id="pickup_enabled" style="display:none;">
								<li class="white"><p><span style="float:left;" >PICKUP (<small>Unavailable</small>) </span>  <aside style="float:left;"> Pickup is not available at this time.</aside></li>
							</a>
							<a href="javascript:void(0);" id="delivery_enabled" style="display:none;">
								<li class="white"><p><span style="float:left;" >Delivery (<small>Unavailable</small>) </span>  <aside style="float:left;"> Delivery is not available at this time.</aside></li>
							</a>
							<a href="javascript:void(0);" id="order_pickup">
								<li class="white"><p><span style="float:left;" id="method_chosen_pickup">PICKUP -</span>  <aside style="float:left;" id="method_chosen_pickup_info">at the new location, address of New Location.</aside></p></li>
							</a>
							<a href="javascript:void(0);" id="order_delivery">
								<li class="gray"><p><span id="method_chosen_delivery" style="float:left;">DELIVERY -</span><aside style="float:left;" id="method_chosen_delivery_info">Your order will be delivered to you as soon as possible.</aside></p></li>
							</a>	
						</div>
...
$(document).delegate('[id^="selectedLocation_"]', 'click', function() {
	...
	var location_id = this.id;
		...
		var merchant_id = $('#merchant_id_'+location_id).val();
    ...
    $.ajax({
        ...
        type: 'post',
        data: {locationId : location_id,merchantId : merchant_id},
        dataType: 'json',
        beforeSend: function() {
        	//$('#button-login').button('loading');
		},
